      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Custom Automation <br className="hidden sm:block" />That Drives Growth
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Done-for-you automation systems using OpenAI, Zapier, Make, and custom APIs—whatever gets the job done best.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Automated systems that capture and nurture leads 24/7, turning prospects into customers while you focus on growth."
            index={0}
          />
          <FeatureCard
            ...
            description="Eliminate manual processes with custom workflows that connect your tools and automate repetitive business operations."
            index={1}
          />
          <FeatureCard
            ...
            title="Team Bandwidth Recovery"
            description="Free up your team from repetitive tasks so they can focus on high-value work that drives real business results."
            index={2}
          />
          <FeatureCard
            ...
            description="Seamlessly connect your existing tools with custom APIs and workflows that scale with your business growth."
            index={3}
          />
          <FeatureCard
            ...
            description="Analyze and optimize existing automation setups, replacing duct-tape solutions with scalable systems that hold up."
            index={4}
          />
          <FeatureCard
            ...
            description="Work directly with me—no bloated teams or vague timelines. Just fast, effective execution and measurable results."
            index={5}
          />
        </div>
      </div>
