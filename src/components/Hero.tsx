      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Eliminate Manual Tasks.<br className="hidden sm:inline" />Drive Real Growth.
            </h1>
            ...
            >
              Custom AI automation systems that eliminate repetitive tasks and accelerate business growth. From strategy to implementation—clean, efficient solutions that just work.
            </p>
